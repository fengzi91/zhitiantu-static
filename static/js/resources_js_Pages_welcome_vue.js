...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "flex min-h-screen flex-col justify-center items-center" },
    [
      _c("div", { staticClass: "container" }, [
        _c(
          ...
          {
            staticClass:
              "shadow-lg max-w-7xl mx-auto px-4 py-5 rounded-lg text-center"
          },
          [
            _c("p", { staticClass: "text-teal-500" }, [
              _vm._v(_vm._s(_vm.content))
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "mt-6" }, [
              _vm._v("counter: " + _vm._s(_vm.count) + " "),
              _c(
                "button",
                {
                  staticClass:
                    "relative w-full sm:w-auto block text-sm font-semibold bg-teal-600 rounded-lg text-white py-3 px-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 hover:bg-teal-500",
                  on: { click: _vm.add }
                },
                [_vm._v("add")]
              )
